    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.PositiveIntegerField(default=0, help_text='Укажите стоимость курса', verbose_name='Стоимость')),
                ('is_available', models.BooleanField(default=True, verbose_name='Курс доступен')),
            ],
            options={
                'verbose_name': 'Курс',
